...
function wesnoth.effects.ic2_optional_attack(u, cfg)
	local name_suffix = cfg.name_suffix or helper.wml_error("apply_to=ic2_optional_attack missing required name_suffix= attribute.")
	local attack_mod = wml.get_child(cfg, "attack") or helper.wml_error("apply_to=ic2_optional_attack missing required [attack] subtag")
...
function wesnoth.effects.ic2_moves_defense(u, cfg)
...
function wesnoth.effects.ic2_min_resistance(u, cfg)
...
function wesnoth.effects.ic2_min_defense(u, cfg)
	local defense_new = {}
...
function wesnoth.effects.ic2_update_aura(u, cfg)
...
function wesnoth.effects.ic2_overlay(u, cfg)
	if cfg.add then
...
function wesnoth.effects.ic2_move_on_recruit(u, cfg)
	u.variables["mods.ic2_move_on_recruit"] = true
end

-- The implementation of this mods reduced recall costs, all units get an object with this effect.
function wesnoth.effects.ic2_recall_cost(u, cfg)
