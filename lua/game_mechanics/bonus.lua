...
function wesnoth.wml_actions.ic2_place_bonus(cfg)
	local x = cfg.x or wml.error("[ic2_place_bonus] missing required 'x' attribute")
	local y = cfg.y or wml.error("[ic2_place_bonus] missing required 'y' attribute")
	local scenery = cfg.scenery or wml.error("[ic2_place_bonus] missing required 'scenery' attribute")
	local c_scenery = bonus.sceneries[scenery]
	if not c_scenery then
		wml.error("[ic2_place_bonus] invalid 'scenery' attribute: ".. tostring(scenery))
		end
