...
local function get_enemy_data(enemy_power)
	return {
		...
		sides = {
			...
			wct_enemy(5, 0, 1, 0, 0, "$($ic2_difficulty.enemy_power-4)", 1),
			wct_enemy(6, 1, 1, 0, 0, "$($ic2_difficulty.enemy_power-5)", 1),
			wct_enemy(7, 0, 0, 3, 0, "$($ic2_difficulty.enemy_power-4)", 1),
		}
	}
end
