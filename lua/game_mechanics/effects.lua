...
function wesnoth.effects.ic2_optional_attack(u, cfg)
	local name_suffix = cfg.name_suffix or wml.error("apply_to=ic2_optional_attack missing required name_suffix= attribute.")
	local attack_mod = wml.get_child(cfg, "attack") or wml.error("apply_to=ic2_optional_attack missing required [attack] subtag")
