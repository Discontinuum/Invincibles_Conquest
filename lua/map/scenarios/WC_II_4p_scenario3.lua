...
local function get_enemy_data(enemy_power)
	return {
		...
		bonus_gold = 140,
		sides = {
			wct_enemy(5, 0, 0, 0, 0, 7, 1, 0),
			wct_enemy(6, 0, 0, 6, 0, 7, 3, 0),
			wct_enemy(7, 1, 1, 0, 0, "$($ic2_difficulty.enemy_power-3)", 4, 0),
		}
	}
end
return { generators = generators, get_enemy_data = get_enemy_data, turns = 29, player_gold = 200 }
