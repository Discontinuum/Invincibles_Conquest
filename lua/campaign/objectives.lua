...
function wesnoth.wml_actions.ic2_objectives(cfg)
	wesnoth.wml_actions.objectives {
		...
		wml.tag.note {
			description = strings.difficulty .. wml.variables["ic2_difficulty.name"],
		},
		wml.tag.note {
			description = strings.version .. wml.variables["ic2_host_version"],
		},
		note = ic2_color.help_text(strings.help_available)
	}
end
