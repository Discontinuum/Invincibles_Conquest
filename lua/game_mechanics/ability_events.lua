...
--- TODO: investigate why it triggers on GSE triumvirate units
	...
	local matches = unit.variables["mods.ic2_move_on_recruit"]
...
on_event("attack_end", function(cx)
	...
	if not u:matches { wml.tag.has_attack { special_id_active = "ic2_disengage"} } then
