...
function wesnoth.wml_actions.ic2_map_supply_village(t)
	...
	local supply_image = ((wml.variables.ic2_supply_image_counter or 0) % #supply_images ) + 1
	wml.variables.ic2_supply_image_counter = supply_image
