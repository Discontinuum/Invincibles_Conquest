...
function world_conquest_tek_map_decoration_2c()
	...
	local r = mathx.random_choice(tostring(scenario_data.total_tiles // 285) .. ".." .. tostring(scenario_data.total_tiles // 150))
	...
	local r = mathx.random_choice(tostring(scenario_data.total_tiles // 250) .. ".." .. tostring(scenario_data.total_tiles // 150))
